...
export const metadata: Metadata = {
  title: "Privacy Policy · Quipus",
  description: "How Quipus collects, uses, and protects account and conversation data.",
};
    ...
    <main className={styles.page}>
      <div className={styles.shell}>
        ...
        <article className={styles.article}>
          ...
          <p>
            Quipus is a conversation memory and follow-up prototype. This policy
            explains the information Quipus handles when you sign in, connect a
            device, process a conversation, or connect Google Calendar.
          </p>

          <h2>Information Quipus handles</h2>
          <ul>
          ...
          <p>
            Quipus uses this information to authenticate you, keep your workspace
          ...
          <p>
            Quipus requests Calendar event access so it can create or update only
            ...
            storage and are tied to the Quipus account that granted access. Quipus
            does not sell Google user data or use it for advertising.
          </p>
          <p>
            Quipus&apos;s use and transfer of information received from Google APIs
          ...
          <p>
            Quipus uses service providers to run the product: Supabase for account
            ...
            understanding. When Exa is enabled, Quipus sends public company names
          ...
          <p>
            ...
            encrypted on the server. Quipus keeps account and workspace data while
          ...
          <h2>Your choices</h2>
          <p>
            You can decline Calendar access and still sign in. You can revoke Quipus
            in your Google Account permissions. To request access, correction, export,
            or deletion of your Quipus data, email{` `}
